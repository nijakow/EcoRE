...
extern struct Eco_Type* Eco_Type_INTEGER;
extern struct Eco_Type* Eco_Type_FLOATING;
...
static inline void Eco_Any_AssignPointer(Eco_Any* any, struct Eco_Object* object, struct Eco_Type* type)
{

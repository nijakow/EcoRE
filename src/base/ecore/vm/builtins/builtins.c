...
void Eco_VM_Builtins_Init()
{
    ...
    Eco_VM_Builtins_AddBuiltin("ecosphere.ecore.fiber.start", Eco_VM_Builtin_StartFiber);
    Eco_VM_Builtins_AddBuiltin("ecosphere.ecore.fiber.yield", Eco_VM_Builtin_Yield);
    ...
    Eco_VM_Builtins_AddBuiltin("ecosphere.ecore.init.set_basic_error", Eco_VM_Builtin_SetBasicError);
